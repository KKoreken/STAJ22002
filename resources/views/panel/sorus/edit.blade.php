...
@section('body')
    ...
    @section('content')
        <div class="row">
            <div class="col-xl-12">
                <form action="{{route('soru-update')}}" method="post" enctype="multipart/form-data">@csrf
                                ...
                                <div class="tab-content pt-4">
                                    <div class="tab-pane active show" id="isler" role="tabpanel">
                                        <div class="my-2">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-7 my-2 col-md-12">
                                                    ...
                                                    <select onchange="typeCheck();" id="type"  style="width: 100%" class="js-example-basic-single form-control" name="type">
                                                        <option @if($item->type=='text') selected @endif value="text">Metin</option>
                                                        <option @if($item->type=='email') selected @endif value="email">Eposta Adresi</option>
                                                        <option @if($item->type=='date') selected @endif value="date">Tarih</option>
                                                        <option @if($item->type=='number') selected @endif value="number">Numara</option>
                                                        <option @if($item->type=='email') selected @endif value="email">Eposta</option>
                                                        <option @if($item->type=='select') selected @endif value="select">Seçenek</option>
                                                        <option @if($item->type=='checkbox') selected @endif value="checkbox">Kutucuk</option>
                                                    </select>
                                                </div>
                                                <div class="col-xl-7 my-2 col-md-12">
                                            ...
                                            <div id="attributeDiv" >
                                                <!-- Select icin div -->
                                                <div id="selectdiv" class="select-options attribute-div @if($item->type !='select') d-none @endif">
                                                                ...
                                                                <div class="table-responsive mt-3">
                                                                    <table class="table table-hover" id="candidateTable">
                                                                        ...
                                                                        @foreach($options as $index => $option)
                                                                            <tr>
                                                                                <td>
                                                                                    <input class="form-control" type="text" name="option[{{ $index }}]" value="{{ $option }}" placeholder="Seçenek Giriniz">
                                                                                </td>
                                                                                <td>
