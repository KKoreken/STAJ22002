            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{route('form.add')}}"><button  class="btn btn-success" id="btn-save-event">Yeni Ekle</button></a>
                    </div>
                    <div class="card-body">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end " style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate3d(-40px, 30px, 0px);" data-popper-placement="bottom-end">
                                                <a class="dropdown-item" href="{{route('form.answers',['id'=>$work->id])}}">Cevaplar</a>
                                                <a class="dropdown-item" href="{{route('form.edit',['id'=>$work->id])}}">Düzenle</a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item" href="{{route('form.delete',['id'=>$work->id])}}">Sil</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
