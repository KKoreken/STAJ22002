                                    ...
                                    <div>
                                        ...
                                        <div class="card-body">
                                            <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap"
                                                ...
                                                <tbody>
                                                @foreach($work->isSahipligi as $user)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end " style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate3d(-40px, 30px, 0px);" data-popper-placement="bottom-end">
                                                                    <a class="dropdown-item" href="{{route('panel-user-details',['id'=>$user->user->id])}}">İncele</a>
                                                                    <a class="dropdown-item" href="{{route('panel-user-edit',['id'=>$user->user->id])}}">Düzenle</a>
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    eventPositioned: function(event, element) {
                        element.css('z-index', event.start.getTime());
                    },
                    // responsive
